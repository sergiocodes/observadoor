...
<head>
    ...
    <!-- Alertify CSS-->
    <link href="librerias/alertify/css/alertify.css" rel="stylesheet" media="all">
...
<body class="animsition">
		...
		<div class="main-content">
			<div class="card">
				...
				<div class="card-body card-block">
                    <form action="usu_reservas_2.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="select" class=" form-control-label">¿Estás registrado como visitante?</label>
                        </div>
    ...
    <script>
        const map = {
        con: 'usu_reservas_cc.php',
        sin: 'usu_reservas_sc.php'
        }
