                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Administrador - Inicio</h2>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#eventos_disponibles').load('componentes/cant_eventos_disp_tot.php');
    });
</script>

<script type="text/javascript">
    $(document).ready(function(){
        $('#cuentas_usuario').load('componentes/cant_cuentas_usuario.php');
    });
</script>