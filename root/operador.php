...
<head>
    ...
    <!-- Title Page-->
    <title>ObservaDoor - Operador - Inicio </title>
                    ...
                    <ul class="list-unstyled navbar__list">
						...
						<li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                ...
                                <li>
                                    <a href="#">Visitas actuales</a>
                                </li>
								 <li>
                                    <a href="#">Estado reservas</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Operador - Inicio</h2>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="overview-item overview-item--c1">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <div id="res_sin_vali"></div>
                                                <span>Reservas sin validar</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="overview-item overview-item--c3">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <div id="res_sin_confirmar"></div>
                                                <span>Reservas sin confirmar</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#res_sin_vali').load('componentes/cant_res_sin_val.php');
    });
</script>

<script type="text/javascript">
    $(document).ready(function(){
        $('#res_sin_confirmar').load('componentes/cant_res_sin_con.php');
    });
</script>